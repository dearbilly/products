			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-6 product_image">
                       <img src="./images/<?php echo $product[0]['image']; ?>" />
					</div>

					<div class="col-lg-6 product_col">
						<div class="product_info">
                            <!-- Product name <div class="product_name"></div> -->
							<div class="product_name"><?php echo $product[0]['name']; ?></div>
							...
							<div class="product_price"><?php echo $product[0]['price']; ?></div>
							...
							<div class="product_buttons">
								<div class="text-right d-flex flex-row align-items-start justify-content-start">
                                    ...
                                    <form name="tocart" method="post" action="?page=cart" style="display: none;">
                                       ...
                                       <input type="hidden" name="hook" value='<?php echo 'ToCart'; ?>' />
                                    </form>
